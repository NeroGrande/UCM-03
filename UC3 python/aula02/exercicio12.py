...
print                                                          ("Exercício 12: Consumo de Energia por Aparelho")

#Crie um programa que calcule o consumo total de energia de vários aparelhos em uma casa. 
#Pergunte o consumo de cada aparelho em kWh e a quantidade de horas que o aparelho fica ligado por dia. 
#O programa deve somar o consumo diário de todos os aparelhos e calcular o custo total de energia no mês.
